const styles = theme => ({
    ...
    height: '100%',
    overflowY: 'hidden',
    paddingBottom: props => `calc(${
      props.terminalHeight ? props.terminalHeight : "0px" } + ${
        props.statusBarHeight ? props.statusBarHeight : "0px"} * 2)`,
		display: 'flex',
		alignItems: 'center',
  ...
  methodContainerStyle: {
    ...
    backgroundColor: props => props.prefersDarkMode ? '#1e1e1e' : '#fffffe'
  },
