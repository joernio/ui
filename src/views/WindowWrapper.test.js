...
const getWindowInfo = jest.spyOn(windowInfoApi, "getWindowInfo").mockImplementation(() => {});
const setOpenFileName = jest.spyOn(windowActionApi, "setOpenFileName").mockImplementation(() => {});
...
describe('WindowWrapper component:', ()=>{
    ...
    beforeEach(()=>{
        let wrapper_and_store = setUp({settings,status, files, query, workspace});
