...
const getSettingsInitialValues = jest.spyOn(sideNavScripts, "getSettingsInitialValues");


const setUp =(initialState={})=> {
    const store = testStore(initialState);
    const wrapper = mount(<SideNav store={store} 
                          terminalHeight="" drawerWidth="" 
                          sideNavWidth="" handleSetState={handleSetState}/>);
...
describe('SideNav component:', ()=>{
    ...
    beforeEach(()=>{
        let wrapper_and_store = setUp({settings});
