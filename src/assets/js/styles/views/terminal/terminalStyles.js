const styles = theme => ({
  terminalStyle: {
    ...
    backgroundColor: props => 
      props.settings.prefersDarkMode ? (props.settings.prefersTerminalView ? '#000000' : theme.palette.explorer.background.dark) : (props.settings.prefersTerminalView ? '#ffffff' : theme.palette.explorer.background.light),
    borderTop: props =>
      `1px solid ${
  ...
  terminalControlItemsStyle: {
    color: props => 
      props.settings.prefersDarkMode ? (props.settings.prefersTerminalView ? '#ffffff' : theme.palette.explorer.base.dark) : (props.settings.prefersTerminalView ? '#000000' : theme.palette.explorer.base.light),
    marginRight: '1.5em',
    zIndex: 4,
    cursor: 'pointer',
  },
